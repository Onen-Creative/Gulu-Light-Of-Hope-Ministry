    ...
    <div>
      ...
      <section className="relative h-[600px] flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white text-center">
          ...
          <div className="bg-white/10 backdrop-blur-sm border-l-4 border-white p-6 mb-8 max-w-3xl mx-auto rounded-lg">
            <p className="text-xl italic mb-2 font-medium">
              "You are the light of the world. A city set on a hill cannot be
              hidden."
            </p>
            <p className="text-lg text-gray-200">Matthew 5:14 (NKJV)</p>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/about"
              className="bg-white text-primary-600 px-8 py-4 rounded-lg font-semibold hover:bg-primary-50 transition-all shadow-lg inline-flex items-center justify-center text-lg"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-xl">
              <div className="flex items-center mb-6">
                <div className="relative w-24 h-24 rounded-full overflow-hidden mr-6 ring-4 ring-primary-200">
                  <CloudinaryImage
            ...
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-xl">
              <div className="flex items-center mb-6">
                <div className="relative w-24 h-24 rounded-full overflow-hidden mr-6 ring-4 ring-secondary-200">
                  <CloudinaryImage
