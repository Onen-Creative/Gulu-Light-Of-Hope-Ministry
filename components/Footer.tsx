        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              A Beacon of Hope and Spiritual Nourishment, advancing the Gospel of Jesus Christ and serving communities through worship, outreach, education, and community development.
            </p>
            ...
            <div>
              ...
              <div className="flex space-x-3">
                ...
                <a
                  href="https://wa.me/256782509058"
                  className="bg-white/10 hover:bg-green-600 p-3 rounded-full transition-all hover:scale-110"
                  aria-label="WhatsApp"
                  target="_blank"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm text-center md:text-left">
              © {new Date().getFullYear()} Gulu Light of Hope Bible Church & Outreach Ministries. All rights reserved.
            </p>
